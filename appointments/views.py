...
def student_dashboard(request):
    ...
    return render(request, 'appointments/student_dashboard.html', {'appointments': appointments})
...
def advisor_dashboard(request):
    ...
    return render(request, 'appointments/career_advisor_dashboard.html', {
        'waiting': waiting,
        'approved': approved,
        'rejected': rejected,
    })
